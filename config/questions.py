...
website = "https://github.com/Im-Shivam-Singh"

# Please provide the link to your LinkedIn profile.
# "https://www.linkedin.com/in/example" or "" and so on...
...
linkedin_headline = "SDE @ Tata Communications | React, Python/Django, AWS | CPaaS, Plugins & AI"

# Your summary in quotes, use \n to add line breaks if using single quotes "Summary".You can skip \n if using triple quotes """Summary"""
linkedin_summary = """
Full-Stack Software Engineer, I specialize in building scalable, dynamic, and visually compelling digital solutions. 
Frontend: React, JavaScript, HTML, CSS (with a strong focus on modern design and animation)
Backend: Python (Django, Flask), Node.js
Cloud & Deployment: AWS cloud solutions for reliable, scalable applications
"""
